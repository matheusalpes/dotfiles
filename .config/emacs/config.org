#+TITLE: Matheus Alexander's GNU Emacs Config
#+AUTHOR: Matheus Alexander
#+DESCRIPTION: Matheus Alexander's personal GNU Emacs config.
...
- [[#buffer-management][Buffer Management]]
  - [[#buffer-move-window-management][Buffer Move (Window Management)]]
...
#+begin_src emacs-lisp
  ...
  (meow-leader-define-key
   ...
   ;; ORG Mode
   '("oa" . org-agenda)
   '("oA" . (lambda () (interactive) (find-file "~/Desktop/Agenda.org")))
   '("oe" . org-export-dispatch)
   '("oi" . org-toggle-item)
   '("ot" . org-todo)
   '("ob" . org-babel-tangle)
   '("oT" . org-todo-list)
   '("oh" . org-table-insert-hline)
   '("od" . org-time-stamp)

   ;; Reload Emacs
   '("rr" . (lambda () (interactive) (load-file "~/.emacs.d/init.el")))
...
*** Agenda Files
#+begin_src emacs-lisp
  (setq org-agenda-files '("~/Desktop/Agenda.org" "~/Documents/Roam/Roam_Agenda.org"))
#+end_src
    ...
    (org-roam-capture-templates
     '(("d" "default" plain
       ...
       ("b" "book notes (ABNT)" plain
        (file "~/Documents/Roam/Templates/BookNotes.org")
        :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n#+filetags: Book\n#+date: %U\n\n")
        :unnarrowed t)
       ("c" "cornell" plain
        (file "~/Documents/Roam/Templates/CornellNotes.org")
        :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n#+filetags: Study\n#+date: %U\n\n")
        :unnarrowed t)
       ("p" "project" plain
        "\n* PROJECT ${title} :toc:\n* Goals\n- [ ] %?\n- [ ] \n- [ ] \n\n* Roadmap\n** 1st Step\n- \n\n** 2nd Step\n -\n\n** 3rd Step\n- \n\n"
...
(use-package dashboard
  ...
  (setq dashboard-banner-logo-title "The 90s called!")
